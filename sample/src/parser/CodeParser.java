...
public class CodeParser {
     ...
     public LinkedList KeyWords = new LinkedList();

     public LinkedList charArray = new LinkedList();

     public LinkedList finalList = new LinkedList();

     public File test;

     public List wordList = new List();

    int line = 0;

    public CodeParser(String filepath)throws IOException {

        this.test = new File(filepath);
        try {
            this.analizeText();
        }catch (Exception e) {
            return;
